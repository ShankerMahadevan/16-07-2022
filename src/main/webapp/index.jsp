    ...
    <div class="catagory_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            Every Catogery Books Available For Free
          </p>
        </div>
        <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Our platform gives independent books to compete online and financial support to help them maintain their presence in local communities.
            </p>
            <a href="">
              Read More
            </a>
      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          <div class="client_container ">
            <div class="detail-box">
              <p>
              This is a very big book library and all most full books are there . World wide all book stories is there I like it.
                </p>
              <span>
        ...
        <div class="col-md-6 mx-auto">
          <div class="client_container ">
            <div class="detail-box">
              <p>
               The Bookshop is very good and  cost is very cheap and good
              </p>
              <span>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </span>
        ...
        <div class="col-lg-6 mx-auto">
          <div class="client_container ">
            <div class="detail-box">
              <p>
                We get any type of author book student book.people should try here cheap and best cost.all type of books available in this store
              </p>
              <span>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </span>
